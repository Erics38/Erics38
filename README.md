...
like Yelp, PitchBook, and NTT Data. I'm currently pursuing roles at the
intersection of customer onboarding, solutions engineering, and developer
tooling.
...
**Stack:** n8n · OpenWeatherMap API · Webhook notifications
...
Cloud:        AWS (EC2 · S3 · Lambda · VPC · IAM · CloudWatch)
Containers:   Docker · Docker Compose
Automation:   n8n · Zapier
AI/ML:        Local LLMs (llama.cpp) · AWS Bedrock · Prompt Engineering
Tools:        Git · GitHub Actions · VS Code · Claude Code
```
...
I'm always open to conversations about SaaS, onboarding, technical sales,
or anything at the edge of customer success and engineering.

**[Connect on LinkedIn](https://www.linkedin.com/in/eric-syvertsen38/)**
